# Graph Report - eras-photo  (2026-07-16)

## Corpus Check
- 135 files · ~517,031 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1173 nodes · 1538 edges · 104 communities (63 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.71)
...
3. `sha256` - 15 edges
4. `Connect / platforms` - 15 edges
5. `scripts` - 13 edges
6. `ExceptionInfo` - 13 edges
7. `ExceptionInfo` - 13 edges
8. `getStripePlan()` - 12 edges
9. `Security best practices` - 12 edges
10. `Tax / Stripe Tax` - 12 edges
...
## Communities (104 total, 41 thin omitted)
...
Cohesion: 0.05
Nodes (43): dependencies, drizzle-orm, @huggingface/transformers, lucide-react, @mediapipe/tasks-vision, @neondatabase/auth, @neondatabase/auth-ui, @neondatabase/neon-js (+35 more)
...
Cohesion: 0.07
Nodes (48): POST(), HistoryPanel(), HistoryPanelProps, OverviewPanel(), OverviewProps, PRE_FLIGHT_ITEMS, SettingsPanel(), SettingsProps (+40 more)
...
Cohesion: 0.07
Nodes (39): FilterControls(), FilterControlsProps, Filters, SpecCard(), SpecCardProps, WARNING_ORDER, REQUIREMENTS, UploadZone() (+31 more)
...
Cohesion: 0.20
Nodes (9): POST(), GET(), GET(), isAdminEmail(), { GET, POST, PUT, DELETE, PATCH }, deleteApplicantData(), exportApplicantData(), getNeonAuthConfig() (+1 more)

### Community 26 - "rate-limit.ts"
Cohesion: 0.19
Nodes (13): POST(), claimApplicantDownload(), authLimiter, checkAuthRateLimit(), checkDownloadRateLimit(), checkoutLimiter, downloadLimiter, getClientIp() (+5 more)
...
Cohesion: 0.22
Nodes (10): GET(), getApplicantPlan(), createDatabase(), getDatabase(), ApplicantProfile, applicantProfiles, NewApplicantProfile, NewPhotoRecord (+2 more)
